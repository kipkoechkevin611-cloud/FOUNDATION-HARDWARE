...
export default function WhatsAppButton() {
  const { items, totalItems, generateWhatsAppMessage } = useCart();

  // If cart has items, link to cart page instead of direct WhatsApp
  const href = items.length > 0 ? "/cart" : "https://wa.me/254788874942";
  const target = items.length > 0 ? undefined : "_blank";
